...
import '../../component/home_icon_item.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            const IconButton(icon: Icon(Icons.all_inbox_rounded), onPressed: null),
            const IconButton(icon: Icon(Icons.add_alert_outlined), onPressed: null),
            Stack(
              children: [
                Container(
                  width: 60,
            ...
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Center(child: Text("나우 편성표", style: TextStyle(fontSize: 20, color: Colors.white60),)),
                          ),
                          Container(
                            height: 40,
                            width: 10,
                            ...
                            child: const Center(child: Text("|", style: TextStyle(fontSize: 20, color: Colors.white60),)),
                          ),
                          Container(
                            height: 40,
                            width: MediaQuery.of(context).size.width * 0.4,
              ...
              Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: const [
                      HomeIconItem(iconText: '확진현황', icon: Icons.addchart),
                      HomeIconItem(iconText: '잔여백신알림', icon: Icons.alt_route_sharp),
                      HomeIconItem(iconText: '선별진료소', icon: Icons.add_location),
                      HomeIconItem(iconText: '팩트체크', icon: Icons.wb_auto_outlined),
                    ],
                  )
              ),
...
class HomeCard2 extends StatelessWidget {
  final String text1;
  final String text2;
  const HomeCard2({Key? key, required this.text1, required this.text2}) : super(key: key);
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(text1, style: const TextStyle(color: Colors.deepPurpleAccent, fontWeight: FontWeight.bold),),
                    Text(text2)
                  ],
                ),
                const CircleAvatar(
